/*
 * Copyright (c) 2008, 2011  Weston Schmidt
 *
 * Parts of this file are from linux/include/linux/crc-itu-t.h
 * Parts of this file are from linux/lib/crc-itu-t.c
 * Parts of this file are from linux/include/linux/crc7.h
 * Parts of this file are from linux/lib/crc7.c
 *
...
uint16_t crc16( const uint8_t *message, const size_t length )
{
    ...
    while( i-- ) {
        crc = crc_itu_t_byte( crc, *message++ );
    }
